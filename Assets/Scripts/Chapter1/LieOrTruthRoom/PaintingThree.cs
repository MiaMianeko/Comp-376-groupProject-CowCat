...
public class PaintingThree : Interactable
{
            ...
            switch (_lieOrTruthGameManager.roundNumber)
            {
                case 1:
                    StartCoroutine(FileReader.GetText(
                        Application.streamingAssetsPath + "/Dialogs/Painting3Dialog1.json",
                        jsonData =>
                        {
                ...
                case 2:
                    StartCoroutine(FileReader.GetText(
                        Application.streamingAssetsPath + "/Dialogs/Painting3Dialog2.json",
                        jsonData =>
                        {
                            DialogData dialogData = JsonUtility.FromJson<DialogData>(jsonData);
                            StartCoroutine(_dialog.OutputDialog(dialogData, () =>
